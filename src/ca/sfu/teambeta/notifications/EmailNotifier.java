...
public class EmailNotifier implements Notifier {
    private static final String EMAIL_SMTP_HOSTNAME = "";
    ...
    private static final String FROM_EMAIL_ADDRESS = "email@example.com";
    private static final String FROM_EMAIL_ADDRESS_NAME = "Admin";
